...
frequencies below the microwave region $f < 1000\text{MHz})$, about 40 percent
...
elements of the skin.  A tolerance figure of $0.001\text{ }{watt}\text{
}{cm}^2$ for long-term exposures has been considered adequate. Surface burns
resulting from R.F.  currents are similar to those encountered at lower
frequencies.
...
exceeded. As the frequency increases $f > 3000\text{MHz}$, the incident energy
